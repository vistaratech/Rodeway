...
namespace FlutterUnityIntegration.Editor
{
    public class Build : EditorWindow
    {
        ...
        // Sets the NDK version
        // Note: This uses Android Studio's NDK path (Android Studio -> Tools -> SDK Manager -> SDK Tools -> NDK)
        private static string ndkVersion = "27.0.12077973";
        private static string ndkPath = $"\"{Environment.GetFolderPath(Environment.SpecialFolder.UserProfile).Replace("\\", "\\\\")}\\\\AppData\\\\Local\\\\Android\\\\Sdk\\\\ndk\\\\{ndkVersion}\"";
...
#unity-mobile-warning { position: absolute; left: 50%; top: 5%; transform: translate(-50%); background: white; padding: 10px; display: none }
        ...
        private static void ModifyAndroidGradle(bool isPlugin)
        {
            ...
            buildText = buildText.Replace("\"C:/Program Files/Unity/Hub/Editor/2022.3.55f1/Editor/Data/PlaybackEngines/AndroidPlayer/NDK\"", $"{ndkPath}");
